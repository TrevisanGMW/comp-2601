 ...
 * o	Constructor will take parameters for title, artist, number of tracks, size, and weight.
 *      Appropriate validations will be done and IllegalArgumentExeptions will be thrown when values are bad.
 *
...
public class VinylRecord {
    ...
    public VinylRecord(int numOfTracks, int sizeInches, int weightGrams) {
